...
from sample.providers.transport import get_client
...
def load_python_code_format_preamble() -> str:
    ...
    config_path = Path(__file__).parent.parent / "config" / "rules" / "scoring.json"
...
PYTHON_CODE_FORMAT_PREAMBLE = load_python_code_format_preamble()
...
async def call_model(
    prompt: str, model: str, request_id: str, system_preamble: str | None = None
