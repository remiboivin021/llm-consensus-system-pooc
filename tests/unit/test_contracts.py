...
from sample.contracts.response import ConsensusResult, ModelResponse, Timing
...
def test_consensus_request_rejects_debate_mode():
    with pytest.raises(ValidationError):
        ConsensusRequest(prompt="hello world", mode="debate")
